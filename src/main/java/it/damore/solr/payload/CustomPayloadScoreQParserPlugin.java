...
/**
 * Creates a CustomPayloadScoreQParserPlugin wrapping a SpanQuery created from the input value, applying text analysis and
 ...
 * <br>Example: <code>{!custom_payload_score f=weighted_terms_dpf}Foo Bar</code> creates a SpanNearQuery with "Foo" followed by "Bar"
 */
public class CustomPayloadScoreQParserPlugin extends QParserPlugin {
  public static final String NAME = "custom_payload_score";
  ...
  public QParser createParser(String qstr, SolrParams localParams, SolrParams params, SolrQueryRequest req) {
    return new QParser(qstr, localParams, params, req) {
      ...
      public Query parse() throws SyntaxError {
        ...
        int slop = localParams.getInt("slop", DEFAULT_SLOP);
        boolean inOrder = localParams.getBool("inOrder", DEFAULT_IN_ORDER);
        ...
        SpanQuery query;
        try {
          query = CustomPayloadUtils.createSpanQuery(field, value, analyzer, operator, slop, inOrder);
        } catch (IOException e) {
